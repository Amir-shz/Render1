...
function Page() {
  return (
    <div>
      ...
      <ProfileWarning />
      <div className="bg-slate-200 mx-4 rounded shadow-md shadow-slate-500/25 p-3 grid grid-cols-2 gap-2 max-lg:p-2 max-lg:gap-2 max-lg:grid-cols-1 max-sm:mx-2 ">
        <Specifications />
