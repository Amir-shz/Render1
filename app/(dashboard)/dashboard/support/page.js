    ...
    <div>
      ...
      <div className="bg-slate-200 mx-4 rounded shadow-md shadow-slate-500/25 p-3  max-lg:p-2 max-sm:mx-0 ">
        <div className="bg-slate-100 rounded-sm p-4 shadow pb-2 max-sm:p-2">
          ...
          <form action={handleTicket} className="my-2 space-y-2 ">
            <div className="grid grid-cols-2 items-center gap-2 max-lg:grid-cols-1">
              <div className="grid grid-cols-[1fr_5fr] max-xl:grid-cols-[1fr_4fr] items-center gap-2">
            ...
            <div className="grid grid-cols-[1fr_11fr] max-xl:grid-cols-[1fr_9fr] max-lg:grid-cols-[1fr_4fr] items-center gap-[7px]">
